...
public class PIDTuning extends LinearOpMode {
    ...
    public static double armP = 0.05, armI = 0, armD = 0.00081, armF = 0;
    //    extended PID
    ...
    public static double slideP = 0.023, slideI = 0, slideD = 0, slideF = 0;
...
//        ARM AND SLIDE
    ...
    public void runOpMode(){
        ...
        while(opModeIsActive()){
            ...
            slideTarget = Math.max(10, Math.min(2500, slideTarget));
